...
CREATE TABLE `animalhistoria` (
  ...
  `animalHistoriaFecha` date NOT NULL,
  `animalHistoriaPeso` double NOT NULL,
  `animalHistoriaObs` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`animalId`,`animalHistoriaFecha`),
...
INSERT INTO `animalhistoria` VALUES (1,'2020-03-30',50,'Observacion'),(1,'2020-03-31',75,'Observacion'),(1,'2020-04-01',100,'Observacion'),(2,'2020-04-01',200,'Otra');
...
CREATE TABLE `corralanimal` (
  ...
  `animalId` int NOT NULL,
  `corralFecha` date NOT NULL,
  `corralFechaFin` date DEFAULT NULL,
  PRIMARY KEY (`corralId`,`animalId`,`corralFecha`),
...
CREATE TABLE `engorde` (
  ...
  `tipoRacionId` int NOT NULL,
  `engordeFecha` date NOT NULL,
  PRIMARY KEY (`engordeId`,`corralId`),
...
INSERT INTO `engorde` VALUES (2,1,1,'2020-04-01'),(3,1,1,'2020-04-01');
...
INSERT INTO `tiporacion` VALUES (1,'Ración 1'),(2,'Ración 2'),(3,'Ración 3');
...
-- Dump completed on 2020-04-01 19:54:55
